 ...
 */
package com.demo.myjavademo.utils.reflection;
...
public class Reflections {
    ...
    public static <T, I> Map<I, List<T>> groupListToMap(List<T> list, String groupField) {
        ...
        if (CollectionUtils.isNotEmpty(list)) {
            for (T t : list) {
                Object fieldValue = invokeMethodByName(t, "get" + upperFirst(groupField), null);
    ...
    public static String upperFirst(String str) {
        if (Boolean.TRUE.equals(StringUtils.isEmpty(str))) {
            return "";
        } else {
