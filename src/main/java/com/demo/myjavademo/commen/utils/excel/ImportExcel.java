            ...
            if (cell != null) {
                ...
                if (cell.getCellTypeEnum().compareTo(CellType.NUMERIC) == 0) {
                    if (DateUtil.isCellDateFormatted(cell)) {
                        ...
                        BigDecimal b = BigDecimal.valueOf(cell.getNumericCellValue());
                        //整数
                        if (new BigDecimal(b.toBigInteger()).compareTo(b) == 0) {
                            val = String.valueOf(b.toBigInteger());
                        } else {
                            //小数
                            val = String.valueOf(b.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
                        }
                    }

                } else if (cell.getCellTypeEnum().compareTo(CellType.STRING) == 0) {
                    val = cell.getStringCellValue();
                } else if (cell.getCellTypeEnum().compareTo(CellType.FORMULA) == 0) {
                    val = cell.getCellFormula();
                } else if (cell.getCellTypeEnum().compareTo(CellType.BOOLEAN) == 0) {
                    val = cell.getBooleanCellValue();
                } else if (cell.getCellTypeEnum().compareTo(CellType.ERROR) == 0) {
